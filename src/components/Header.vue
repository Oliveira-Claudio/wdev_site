<template>
    <header>
        <nav class="container">
            ...
            <img v-on:click="openMenu" id="menu-button" src="https://raw.githubusercontent.com/william-costa/wdev-mock-site-resources/master/assets/images/menu.svg" alt="open menu">

            <div v-on:click="closeMenu" id="menu-overlay" v-if="menuActive"></div>

            <div id="menu-items" v-bind:class="{ active: menuActive }">
                ...
                <ul>
                    ...
                    <li @click="closeMenu"><router-link to="/videos">Video</router-link></li>
